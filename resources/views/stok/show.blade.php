                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="stokasal" value="{{ $stok->stokasal }}"
                                class="form-control @error('stokasal') is-invalid @enderror" readonly>
                            @error('stokasal')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jumblahbarangmasuk" value="{{ $stok->jumblahbarangmasuk }}"
                                class="form-control @error('jumblahbarangmasuk') is-invalid @enderror" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jumblahbarangkeluar" value="{{ $stok->jumblahbarangkeluar }}"
                                class="form-control @error('jumblahbarangkeluar') is-invalid @enderror" readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jumblahstok" value="{{ $stok->jumblahstok }}"
                                class="form-control @error('jumblahstok') is-invalid @enderror" readonly>
                            @error('jumblahstok')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
